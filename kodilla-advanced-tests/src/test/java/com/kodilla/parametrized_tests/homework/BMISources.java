...
public class BMISources {
    static Stream<Arguments> providePersonsForBMITest() {
        return Stream.of(
                ...
                Arguments.of(new Person(1.42, 100), "Obese Class IV (Morbidly Obese)"),
                Arguments.of(new Person(1.50, 95), "Obese Class III (Very severely obese)"),
                Arguments.of(new Person(1.47, 80), "Obese Class II (Severely obese)"),
